    ...
    <div className="space-y-6 max-w-4xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3.5 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-brand-400 bg-white"
            >
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <input
                      ...
                      className="w-full px-2 py-2 border border-gray-200 rounded-lg text-xs focus:outline-none focus:border-brand-400"
                    />
                  </div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateVariant(i, { sellingPrice: Number(e.target.value) })
                    }
                    className="w-full px-2.5 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-brand-400"
                  />
                </div>
                ...
                <div className="col-span-2">
                  ...
                  <input
                    value={v.warehouse}
                    onChange={(e) =>
                      updateVariant(i, { warehouse: e.target.value })
                    }
                    className="w-full px-2.5 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-brand-400"
                  />
                </div>
      ...
      <div className="flex gap-3">
        ...
        <button
          onClick={submit}
          disabled={isPending}
          className="flex-1 py-3 bg-brand-700 hover:bg-brand-800 disabled:opacity-60 text-white font-semibold rounded-xl text-sm transition-colors flex items-center justify-center gap-2"
        >
