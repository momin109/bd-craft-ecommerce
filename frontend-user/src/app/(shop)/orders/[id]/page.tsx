...
function OrderDetailContent() {
  ...
  const order = orders?.find(
    (o) => getOrderId(o) === id || o.orderNumber === id,
  );
  ...
  const totalDiscount =
    order.discount + (order.couponDiscount ?? 0) + (order.offerDiscount ?? 0);
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              ...
              <div className="bg-white border border-gray-100 rounded-2xl p-5">
                <div className="flex items-center justify-between mb-5">
                  <h3 className="font-semibold text-gray-800 flex items-center gap-2">
                    <Truck size={16} className="text-brand-600" /> Order
                    Tracking
                  </h3>
                </div>
        ...
        <div className="space-y-4">
          <div className="bg-white border border-gray-100 rounded-2xl p-5">
            ...
            <div className="space-y-2.5 text-sm">
              <div className="flex justify-between text-gray-500">
                <span>Subtotal</span>
                <span>{formatPriceBDT(order.subtotal)}</span>
              </div>
              {totalDiscount > 0 && (
                <div className="flex justify-between text-green-600">
                  ...
                  <span>-{formatPriceBDT(totalDiscount)}</span>
                </div>
              )}
              <div className="flex justify-between text-gray-500">
                <span>Shipping</span>
                <span>{formatPriceBDT(order.shippingCharge)}</span>
              </div>
          ...
          <div className="bg-white border border-gray-100 rounded-2xl p-5">
            <h3 className="font-semibold text-gray-800 mb-3 flex items-center gap-1.5">
              <CreditCard size={14} className="text-brand-600" /> Payment
            </h3>
