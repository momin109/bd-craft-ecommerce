          ...
          {!isAuthenticated ? (
            ...
            <div className="space-y-4">
              {items.map((item, index) => {
                ...
                const size = getCartVariantSize(item);
                const color = getCartVariantColor(item);
                      ...
                      <div className="flex items-center justify-between mt-2">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            disabled={!itemId}
                            className="ml-1 p-1 text-gray-400 hover:text-red-500 transition-colors disabled:opacity-40"
                          >
                            <Trash2 size={14} />
                          </button>
                        </div>
          ...
          <div className="px-5 py-4 border-t border-gray-100 bg-brand-50">
            ...
            <div className="flex justify-between items-center mb-4">
              ...
              <span className="text-sm text-green-600 font-medium">
                {total >= 1500 ? "Free" : formatPriceBDT(80)}
              </span>
            </div>
            ...
            <div className="flex justify-between items-center mb-4 pt-3 border-t border-brand-100">
              ...
              <span className="font-bold text-brand-700 text-lg">
                {formatPriceBDT(total >= 1500 ? total : total + 80)}
              </span>
            </div>
