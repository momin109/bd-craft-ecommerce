...
export const env = {
  ...
  invoice: {
    ...
    companyPhone: process.env.INVOICE_COMPANY_PHONE || "0000000000",
    companyEmail: process.env.INVOICE_COMPANY_EMAIL || "test@email.com",
    companyAddress: process.env.INVOICE_COMPANY_ADDRESS || "Bangladesh",
    publicBaseUrl:
